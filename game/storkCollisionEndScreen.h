#ifndef storkCollisionEndScreen_H
#define storkCollisionEndScreen_H
#include <curses.h>
#include <cstring>
void printText(int HEIGHT, int WIDTH) {
        mvprintw((HEIGHT / 2) + 2, (WIDTH / 2) - strlen("Powod - Zlapany przez Stork") / 2, "Powod - Zlapany przez Stork");
...
void storkCollisionEndScreen(int HEIGHT, int WIDTH) {
        clear();
        const char* text[]{
                "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ",
                "                                                                       /      ",
