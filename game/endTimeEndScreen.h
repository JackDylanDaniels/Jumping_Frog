#ifndef endTimeEndScreen_H
#define endTimeEndScreen_H
#include <curses.h>
#include <cstring>
void endTimeText(int HEIGHT, int WIDTH) {
        mvprintw((HEIGHT / 2) + 2, (WIDTH / 2) - 12, "Powod - koniec czasu");
...
void endTimeEndScreen(int HEIGHT, int WIDTH) {
        clear();
        const char* text[]{
                "= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = ",
                "                                                                       /      ",
